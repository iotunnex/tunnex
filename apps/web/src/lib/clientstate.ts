  ...
  switch (s) {
    ...
    case "revoked":
      return {
        label: "Revoked",
        detail:
          "An administrator revoked this device. The tunnel is down and will not come back until the device is enrolled again.",
        severity: "loud",
 ...
 */
export type TrayAppearance = "solid" | "pulsing" | "grey" | "red";
