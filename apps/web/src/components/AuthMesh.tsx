...
export function AuthMesh() {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none h-full w-full">
      ...
      <rect x="216" y="126" width="48" height="48" rx="12" fill="#0A0A0A" stroke="rgba(255,255,255,0.10)" strokeWidth="1" />
      <image
        href={logoUrl}
        x="224"
        y="134"
      ...
      <g className="tnx-node tnx-afloat2"><circle cx="392" cy="149" r="15" fill="rgba(26,26,26,.95)" stroke="rgba(255,255,255,0.14)" strokeWidth="1" /><g transform="translate(384,141)">{/* Google Cloud's mark — the consumer G is a different product's logo and reads as "sign in with Google", which is the button below, not the cloud this node stands for. */}<path d="M9.7 4.6 L12.4 4.6 L14.9 2.1 L14.8 1.1 A7.6 7.6 0 0 0 2.4 4.8 A0.9 0.9 0 0 1 3 4.7 Z" fill="#EA4335" /><path d="M2.4 4.8 A7.6 7.6 0 0 0 4.7 13.1 L7.4 10.4 A4.5 4.5 0 0 1 5.3 6.8 Z" fill="#FBBC05" /><path d="M14.8 1.1 A7.6 7.6 0 0 1 14.6 13.2 L11.4 10.5 A4.5 4.5 0 0 0 11.6 3.9 Z" fill="#4285F4" /><path d="M4.7 13.1 A7.6 7.6 0 0 0 14.6 13.2 L11.4 10.5 A4.5 4.5 0 0 1 7.4 10.4 Z" fill="#34A853" /></g><text x="408" y="155" fill="#E4E4E1" fontFamily="Instrument Sans" fontSize="12" fontWeight="600">GCP</text></g>
      <g className="tnx-node tnx-afloat"><circle cx="62" cy="256" r="15" fill="rgba(26,26,26,.95)" stroke="rgba(255,255,255,0.14)" strokeWidth="1" /><g transform="translate(54,248)"><polygon points="8,0 14.9,3.9 14.9,11.1 8,15 1.1,11.1 1.1,3.9" fill="none" stroke="#326CE5" strokeWidth="1.6" strokeLinejoin="round" /><circle cx="8" cy="7.5" r="2.5" fill="none" stroke="#326CE5" strokeWidth="1.3" /><g stroke="#326CE5" strokeWidth="1.1" strokeLinecap="round"><line x1="8" y1="2.6" x2="8" y2="5" /><line x1="12.2" y1="5.1" x2="10.1" y2="6.3" /><line x1="12.2" y1="9.9" x2="10.1" y2="8.7" /><line x1="8" y1="12.4" x2="8" y2="10" /><line x1="3.8" y1="9.9" x2="5.9" y2="8.7" /><line x1="3.8" y1="5.1" x2="5.9" y2="6.3" /></g></g><text x="78" y="261" fill="#E4E4E1" fontFamily="Instrument Sans" fontSize="12" fontWeight="600">Kubernetes</text></g>
      ...
      <g className="tnx-node tnx-afloat">
        <circle cx="240" cy="282" r="15" fill="rgba(26,26,26,.95)" stroke="rgba(255,255,255,0.14)" strokeWidth="1" />
        ...
        <g transform="translate(232,274)" fill="none" stroke="#E4E4E1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M1 7 L5.5 2.5 L10 7" />
          <path d="M6 12 L10.5 7.5 L15 12" />
        </g>
        <text x="258" y="288" fill="#E4E4E1" fontFamily="Instrument Sans" fontSize="12" fontWeight="600">MCP server</text>
      </g>
      </svg>
    </div>
  );
