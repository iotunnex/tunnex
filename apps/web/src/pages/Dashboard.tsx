        ...
        <>
          ...
          {data.nodes === 0 && (
            <Card className="mt-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Enroll a tunnex-node agent to start serving WireGuard peers.
              </p>
              <Link
                to="/devices"
          ...
          {data.devices === 0 && data.nodes > 0 && (
            <Card className="mt-4">
              ...
              <Link
                to="/devices"
                className="mt-1 inline-block text-xs text-accent-400 hover:text-accent-500"
              >
          ...
          <ul className="mt-3 space-y-2">
            {data.recent_activity.map((a, i) => (
              <li
                key={i}
                className="flex items-center justify-between rounded-lg border border-white/5 bg-ink-800 px-4 py-2.5"
              >
