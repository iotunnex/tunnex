...
func (a *ssoAdapter) SetConfig(ctx context.Context, orgID uuid.UUID, provider, clientID, clientSecret string, enabled bool) error {
	return a.svc.Configs().Set(ctx, orgID, provider, clientID, clientSecret, enabled)
}
