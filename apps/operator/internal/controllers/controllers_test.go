...
func TestClusterReconcileAccepted(t *testing.T) {
	...
	cr := &tunnexv1.TunnexCluster{
		ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "c", Labels: labeled()},
...
func TestServiceWaitsForCluster(t *testing.T) {
	cluster := &tunnexv1.TunnexCluster{ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "prod-cluster", Labels: labeled()}} // status.ClusterID empty
	svc := &tunnexv1.TunnexExposedService{
		ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "api", Labels: labeled()},
...
func TestServiceExposesWhenClusterReady(t *testing.T) {
	cluster := &tunnexv1.TunnexCluster{
		ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "prod-cluster", Labels: labeled()},
...
func TestGrantWaitsForService(t *testing.T) {
	svc := &tunnexv1.TunnexExposedService{ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "api", Labels: labeled()}} // ServiceID empty
	grant := &tunnexv1.TunnexGrant{
		ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "g", Labels: labeled()},
