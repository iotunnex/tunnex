...
**CURRENT (2026-07-19): EPIC 8 (6 stories) — S8.2c (gateway zero-touch) MERGED (PR#30, rebase-ff `b08d17b`) → EPIC 8 is 4 of 6 (S8.1·S8.2·S8.2c·S8.3 merged). NEXT = S8.4 (DNS) commit-one, FRESH SITTING, with the S8.5-COUPLING CLAUSE (S8.5 open-edition routed subnets shrinks by the S8.2c/S8.4 overlap — scope S8.4's DNS-forwarding against what S8.5 will reuse). S8.4 prereq still owed: the two-part verify-item before S8.4's paper.**
