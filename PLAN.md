...
**CURRENT (2026-07-16): IN EPIC 7 (Zero Trust Access) — visibility/sync arc: S7.1/S7.2/S7.3/S7.4* + S7.5.1 + S7.5.2 MERGED; S7.5.3 (device posture checks) MERGED (PR#24, `e7547ee`). NEXT: S7.5.4 (per-user + temporary grants) — commit-one decision-first, its own fresh sitting.**
