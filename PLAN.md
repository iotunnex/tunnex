...
**CURRENT (2026-07-18): EPIC 8 — S8.2 (route propagation) MERGED (PR#28, sha `2df19df`), 2 of 4. NEXT: S8.3 (site management UI) commit-one — its own fresh sitting (see the S8.3-carries list in the S8.2 bullet below).**
