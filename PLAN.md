...
**S15.0 COMMIT-ONE MERGED (2026-08-04) — PR #80, content tip `f457b81` pre-merge. PAPER ONLY; FIVE RULED,
D17 HELD.** `docs/S15.0-decisions.md`. **Nothing under S15.1 is authorized.**
...
⚠ **D17 HELD. The build shrank and the decisions did not; this paper does not edit the build order.**
