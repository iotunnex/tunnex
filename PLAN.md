...
**CURRENT (2026-07-17): EPIC 8 OPENED — S8.1 (site-to-site model) MERGED (PR#27, sha `e8f6bef`), 1 of 4. NEXT: S8.2 (route propagation) commit-one — its own fresh sitting (see the S8.2-carries list in the S8.1 bullet below).**
