...
**CURRENT (2026-07-17): EPIC 7.5 COMPLETE — S7.5.1/S7.5.2/S7.5.3/S7.5.4/S7.5.5 all MERGED (whole EPIC 7 Zero-Trust arc done). S7.5.5 (MFA/TOTP) MERGED (PR#26, `777c6be`). NEXT: EPIC 8 / S8.1 commit-one — decision-first, its own fresh sitting, CARRYING the BLOCKING ProtocolVersion fail-closed gate item (below).**
